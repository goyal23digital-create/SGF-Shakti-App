...
import { useReturns, useCreateReturn, useUpdateReturn, useVoidReturn, useItems, useParties, useSettings } from '../api/hooks';
        ...
        <form onSubmit={handleSubmit} ref={formRef}>
          ...
          <div className="flex items-end gap-4">
            ...
            <button type="submit" className="btn-primary" disabled={create.isPending || update.isPending}>
              {editId !== null ? (update.isPending ? 'Updating…' : 'Update') : (create.isPending ? 'Saving…' : 'Add Return')}
            </button>
          </div>
